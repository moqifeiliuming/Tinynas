...
class Strategy(metaclass=ABCMeta):
    ...
    # build_xx：Build sub modules from a cfg dict
    ...
    @property
    # A property method to get the budgets value setting in cfg
    def budgets(self,):
        return self._budget_values

    # Compute a score of a network with specified method
    ...
    # Determine if a network meets budget. If dissatisfied, we will drop it
    ...
    # Build a new model from structure info and generate additional information, such as flops/score ans so on.
