...
class Searcher(BaseSearcher):
    ...
    # In search step, all processes pick a random structure info from population and then mutate a new structure info using strategy.
    # If the new network meets the budget and has a high score, we will insert it to the population
    ...
    # Master process collect and assgin newest population with workers and cache intermediate results. Then all processes execute search step
    ...
    # Execute search loop and export the best structure info
